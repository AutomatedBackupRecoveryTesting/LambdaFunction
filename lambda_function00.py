# The following is code taken from AWS Well-Architected Labs. 
# This code will be used as a template for the lambda function I will be creating as part of my proposed solution for the Automated Backup Recovery Testing Project.
# The main changes will be to revise the resource type that is backed up, as well as add a function to validate a DynamoDB table.  
